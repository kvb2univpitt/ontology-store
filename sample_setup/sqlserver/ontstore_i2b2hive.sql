...
-- INSERT INTO i2b2hive.dbo.CRC_DB_LOOKUP (C_DOMAIN_ID,C_PROJECT_PATH,C_OWNER_ID,C_DB_FULLSCHEMA,C_DB_DATASOURCE,C_DB_SERVERTYPE,C_DB_NICENAME,C_ENTRY_DATE) VALUES ('i2b2demo','/ACT/','ontstore','i2b2demodata.dbo','java:/OntologyStoreACTDataDS','SQLSERVER','ACT',CURRENT_TIMESTAMP);
...
INSERT INTO i2b2hive.dbo.CRC_DB_LOOKUP (C_DOMAIN_ID,C_PROJECT_PATH,C_OWNER_ID,C_DB_FULLSCHEMA,C_DB_DATASOURCE,C_DB_SERVERTYPE,C_DB_NICENAME,C_ENTRY_DATE) VALUES ('i2b2demo','/Demo/','ontstore','i2b2demodata.dbo','java:/OntologyStoreDataDS','SQLSERVER','Demo',CURRENT_TIMESTAMP);
INSERT INTO i2b2hive.dbo.ONT_DB_LOOKUP (C_DOMAIN_ID,C_PROJECT_PATH,C_OWNER_ID,C_DB_FULLSCHEMA,C_DB_DATASOURCE,C_DB_SERVERTYPE,C_DB_NICENAME,C_ENTRY_DATE) VALUES ('i2b2demo','Demo/','ontstore','i2b2metadata.dbo','java:/OntologyStoreMetadataDS','SQLSERVER','Metadata',CURRENT_TIMESTAMP);
INSERT INTO i2b2hive.dbo.CRC_DB_LOOKUP (C_DOMAIN_ID,C_PROJECT_PATH,C_OWNER_ID,C_DB_FULLSCHEMA,C_DB_DATASOURCE,C_DB_SERVERTYPE,C_DB_NICENAME,C_ENTRY_DATE) VALUES ('i2b2demo','/ACT/','ontstore','i2b2demodata.dbo','java:/OntologyStoreDataDS','SQLSERVER','ACT',CURRENT_TIMESTAMP);
INSERT INTO i2b2hive.dbo.ONT_DB_LOOKUP (C_DOMAIN_ID,C_PROJECT_PATH,C_OWNER_ID,C_DB_FULLSCHEMA,C_DB_DATASOURCE,C_DB_SERVERTYPE,C_DB_NICENAME,C_ENTRY_DATE) VALUES ('i2b2demo','ACT/','ontstore','i2b2actata.dbo','java:/OntologyStoreMetadataDS','SQLSERVER','ACT Metadata',CURRENT_TIMESTAMP);
