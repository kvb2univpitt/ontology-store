 ...
 * generated in the edu.pitt.dbmi.i2b2.ontologystore.datavo.pm package. 
...
public class ObjectFactory {
    ...
    private final static QName _SetDatasource_QNAME = new QName("http://www.i2b2.org/xsd/cell/pm/1.1/", "set_datasource");
    ...
    private final static QName _GetDatasource_QNAME = new QName("http://www.i2b2.org/xsd/cell/pm/1.1/", "get_datasource");
    ...
    private final static QName _DeleteDdatasource_QNAME = new QName("http://www.i2b2.org/xsd/cell/pm/1.1/", "delete_ddatasource");
    ...
    private final static QName _Datasources_QNAME = new QName("http://www.i2b2.org/xsd/cell/pm/1.1/", "datasources");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.pitt.dbmi.i2b2.ontologystore.datavo.pm
     * 
     */
    ...
    /**
     * Create an instance of {@link UserLoginsType }
     * 
     */
    public UserLoginsType createUserLoginsType() {
        return new UserLoginsType();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/pm/1.1/", name = "get_all_datasource")
    public JAXBElement<String> createGetAllDatasource(String value) {
        return new JAXBElement<String>(_GetAllDatasource_QNAME, String.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/pm/1.1/", name = "set_datasource")
    public JAXBElement<DatasourceType> createSetDatasource(DatasourceType value) {
        return new JAXBElement<DatasourceType>(_SetDatasource_QNAME, DatasourceType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/pm/1.1/", name = "get_datasource")
    public JAXBElement<CellDataType> createGetDatasource(CellDataType value) {
        return new JAXBElement<CellDataType>(_GetDatasource_QNAME, CellDataType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/pm/1.1/", name = "delete_ddatasource")
    public JAXBElement<DatasourceType> createDeleteDdatasource(DatasourceType value) {
        return new JAXBElement<DatasourceType>(_DeleteDdatasource_QNAME, DatasourceType.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.i2b2.org/xsd/cell/pm/1.1/", name = "datasources")
