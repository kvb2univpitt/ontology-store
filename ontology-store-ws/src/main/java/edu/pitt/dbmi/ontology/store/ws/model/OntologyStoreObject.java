...
public class OntologyStoreObject {
    ...
    private String conceptDimension;
    ...
    public String getConceptDimension() {
        return conceptDimension;
    }

    public void setConceptDimension(String conceptDimension) {
        this.conceptDimension = conceptDimension;
    }
