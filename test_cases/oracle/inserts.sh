...
# test case 4
# ================================================================================
# echo exit | sqlplus system/'demouser'@localhost:1521/FREEPDB1 @${DIR}/test_case_4/ontstore_ds_xml.sql
# echo exit | sqlplus i2b2hive/'demouser'@localhost:1521/FREEPDB1 @${DIR}/test_case_4/ontstore_i2b2hive.sql
