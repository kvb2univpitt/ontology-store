...
-- ACT project
GRANT ALL PRIVILEGES ON SCHEMA i2b2actdata TO i2b2ontstoreactdata;
...
-- ACT project
GRANT ALL ON TABLE i2b2actdata.qt_breakdown_path TO i2b2ontstoreactdata;
...
-- ACT project
ALTER DEFAULT PRIVILEGES FOR ROLE i2b2ontstoreactdata IN SCHEMA i2b2actdata GRANT ALL PRIVILEGES ON TABLES TO i2b2actata;
